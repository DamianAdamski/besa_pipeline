...
from supabase_upload import sync_all, sync_acceptance_status, prune_deleted_projects
...
def run_pipeline():
    ...
    try:
        sync_acceptance_status()
    except Exception:
        logger.exception("Could not sync acceptance status to app_runs")
